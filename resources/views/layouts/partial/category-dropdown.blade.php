<div class="relative" @mouseleave="closeDropdown">
    ...
    <div @mouseenter="openDropdown('categories')"
        class="cursor-pointer py-2 px-4 w-52 bg-gray-50 text-gray-700 rounded-tl-md rounded-tr-md hover:bg-gray-100">
        Categories
    </div>

    <!-- Categories Dropdown -->
    <div x-show="activeDropdown === 'categories'" class="absolute top-full left-0 z-10 flex" x-cloak>
        <!-- Main Categories (on the left) -->
        <div class="flex flex-col shadow-lg w-52 min-h-[70vh] bg-white">
        ...
        <div class="absolute left-full top-0 min-w-[40vw] min-h-[70vh] bg-white p-4 border-l"
