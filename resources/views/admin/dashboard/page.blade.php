<x-admin-layout>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div
            ...
            <div>
                ...
                <span class="text-sm text-gray-200">+15% from last month</span>
            </div>
    ...
    <div class="grid mb-5 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <!-- Catalog Section -->
        <div class="bg-white p-4 rounded-md shadow-md border hover:shadow-lg transform transition">
            <h3 class="text-md font-semibold text-blue-600 flex items-center">
                <i class="fas fa-boxes mr-2"></i> Catalog
            </h3>
            <p class="text-sm text-gray-600 mt-1">Manage categories, products, brands, and more</p>
            <a href="{{ route('admin.catalog.index') }}"
                class="inline-block mt-3 px-3 py-1 bg-blue-600 text-white text-sm rounded-md hover:bg-blue-700 transition">Manage
                Catalog</a>
        </div>
        ...
        <div class="bg-white p-4 rounded-md shadow-md border hover:shadow-lg transform transition">
            ...
            <p class="text-sm text-gray-600 mt-1">Track orders, returns, invoices, and transactions</p>
            <a href="{{ route('admin.sales.index') }}"
                class="inline-block mt-3 px-3 py-1 bg-green-600 text-white text-sm rounded-md hover:bg-green-700 transition">Manage
                Sales</a>
        </div>
        ...
        <div class="bg-white p-4 rounded-md shadow-md border hover:shadow-lg transform transition">
            ...
            <p class="text-sm text-gray-600 mt-1">Run marketing campaigns and manage discounts</p>
            <a href="{{ route('admin.marketing.index') }}"
                class="inline-block mt-3 px-3 py-1 bg-yellow-600 text-white text-sm rounded-md hover:bg-yellow-700 transition">Manage
                Marketing</a>
        </div>
        ...
        <div class="bg-white p-4 rounded-md shadow-md border hover:shadow-lg transform transition">
            ...
            <p class="text-sm text-gray-600 mt-1">Manage customers, reviews, and community forums</p>
            <a href="{{ route('admin.engagements.index') }}"
                class="inline-block mt-3 px-3 py-1 bg-indigo-600 text-white text-sm rounded-md hover:bg-indigo-700 transition">Manage
                Engagements</a>
        </div>
        ...
        <div class="bg-white p-4 rounded-md shadow-md border hover:shadow-lg transform transition">
            ...
            <a href="{{ route('admin.settings.index') }}"
                class="inline-block mt-3 px-3 py-1 bg-purple-600 text-white text-sm rounded-md hover:bg-purple-700 transition">Manage
                Settings</a>
        </div>
        <!-- Reports Section -->
        <div class="bg-white p-4 rounded-md shadow-md border hover:shadow-lg transform transition">
            ...
            <p class="text-sm text-gray-600 mt-1">View and analyze platform reports</p>
            <a href=""
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
        <!-- Sales Chart -->
        <div class="bg-white p-4 rounded-md shadow-md hover:shadow-lg">
    ...
    <!-- Add Activity and Notifications Section -->
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        @include('admin.dashboard.system-health-check')
    </div>
