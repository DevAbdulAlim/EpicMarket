    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="bg-white rounded-lg hover:shadow-2xl group">
                ...
                <div class="p-6">
                    <h3 class="text-xl font-semibold mb-2 group-hover:underline">10 Delicious Recipes for Seasonal
                        Fruits</h3>
            ...
            <div class="bg-white rounded-lg hover:shadow-2xl group">
                ...
                <div class="p-6">
                    <h3 class="text-xl font-semibold mb-2 group-hover:underline">5 Easy Steps to Reduce Food Waste at
                        Home</h3>
            ...
            <div class="bg-white rounded-lg hover:shadow-2xl group">
                ...
                <div class="p-6">
                    <h3 class="text-xl font-semibold mb-2 group-hover:underline">How to Store Vegetables to Keep Them
                        Fresh</h3>
